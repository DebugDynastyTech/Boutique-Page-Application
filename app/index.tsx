...
// ── Palette ────────────────────────────────────────────────────
const C = {
  bg:        '#0a2a2a',   // dark teal matching the splash image
  gold:      '#C9A84C',
  goldLight: '#F0D080',
  goldDim:   '#9a7a2e',
  cream:     '#c8b080',
...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    // 4. Pulse glow on the progress bar
    Animated.loop(
      Animated.sequence([
    ...
    // 5. After progress completes, fade out the splash
    setTimeout(() => {
  ...
  return (
    <View style={s.root}>
      ...
      {/* ── WebView — only mounts after splash is fully gone ─── */}
      ...
      {/* ── Splash Screen using the actual splash.png ────────── */}
      {!splashDone && (
